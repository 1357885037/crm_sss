...
layui.use(['form','jquery',"layer"],function() {
    ...
    function showNotice(){
        layer.open({
            ...
            btn: ['火速围观'],
            moveType: 1,
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red">欢迎使用话语系统！！！</p></pclass></p><p>加油奥里给<span class="layui-red">本系统已进行作品版权证明，不管以何种形式获取的源码，请勿进行出售或者上传到任何素材网站，否则将追究相应的责任。</span></p></div>',
            ...
            content :  '<div class="functionSrtting_box">'+
                            '<form class="layui-form">'+
                                ...
                                '<div class="layui-form-item">'+
                                    ...
                                    '<div class="layui-input-block">'+
                                        '<input type="checkbox" name="changeRefresh" checked lay-skin="switch" lay-text="开|关">'+
